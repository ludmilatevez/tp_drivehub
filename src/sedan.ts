...
import { TARIFA_BASE_SEDAN, CARGO_SEDAN, COSTO_MATENIMIENTO_SEDAN } from "./constantes";
 ...
 * El cálculo de costo final depende del kilometraje diario y del factor de ajuste proporcionado por la temporada.
 */
