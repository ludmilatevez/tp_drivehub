 ...
 * La temporada media no modifica la tarifa base del vehículo, ya que aplica un factor de ajuste neutral equivalente a '1'.
 * Este valor se utiliza por las clases de vehículos para calcular el costo final del alquiler.
 */
